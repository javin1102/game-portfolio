...
const DetailModal = ({ modalDetail, open, handleClose }) => {
    ...
    return (
        ...
        border-dark border-4 p-4 flex flex-col items-center overflow-y-scroll focus:outline-none h-[85vh]">
                ...
                <p className="mt-4 text-[0.65rem] md:text-sm">
                    {modalDetail.desc}
                </p>
                ...
                <Links
                    ...
                    appstoreUrl={modalDetail.appstoreUrl}
                />
...
const Links = ({ githubUrl, itchUrl, playstoreUrl, appstoreUrl }) => {
    ...
    const appstore = appstoreUrl ? (
        <li>
            <a className="underline" target="blank" href={appstoreUrl}>
                App Store &rarr;{" "}
            </a>
        </li>
    ) : (
