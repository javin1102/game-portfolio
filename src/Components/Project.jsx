export const Project = ({
	...
	return (
		<div
			className={`text-white ${bgColor} box-content p-8 rounded-lg flex flex-col items-center w-fit justify-self-center h-fit cursor-pointer`}
			onClick={onClick}
		>
			<h2 className="font-bold text-center mb-4 text-base">{title}</h2>
			<img src={src} alt={alt} className=" object-contain rounded-lg" />
			<h2 className=" font-bold text-sm text-center mt-4">Game Overview</h2>
			<p className="text-xs mt-2 w-72 leading-6 flex flex-col items-center text-center">
				{overview}
			</p>
			<h2 className=" font-bold text-sm text-center mt-8">My Contributions</h2>
